...
import com.zh.physiology.assist.StringUtil;
...
//    private Paint paintInerArc_tranform;//内圈蓝色画笔
    ...
    public TemperaturePanelView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawerRecAndText(Canvas canvas, float percent) {
        ...
        speed = StringUtil.floatFormat(12 * percent+34) + unit;
    ...
    private void drawerNum(Canvas canvas) {
        ...
        for (int i = 0; i < mTikeCount + 1; i++) {
            ...
            canvas.drawText("" + (startValue+i), getWidth() / 2 - mArcWidth * 2, 40, paintouter_Num);//画刻度
            canvas.restore();
        }
        canvas.restore();
